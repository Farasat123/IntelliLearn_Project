        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              disabled={isLoading}
              className={`w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white py-3.5 rounded-2xl font-bold shadow-xl shadow-blue-500/25 hover:shadow-blue-500/35 transition-all duration-300 flex items-center justify-center gap-2 ${isLoading ? 'opacity-90 cursor-not-allowed' : ''}`}
            >
              {isLoading ? (
                <>
